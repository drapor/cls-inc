...
-- --------------------------------------------------
-- Date Created: 09/25/2012 14:47:00
...
GO
IF OBJECT_ID(N'[dbo].[FK_SessionGroupe_Session]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[SessionGroupe] DROP CONSTRAINT [FK_SessionGroupe_Session];
GO
IF OBJECT_ID(N'[dbo].[FK_SessionGroupe_Groupe]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[SessionGroupe] DROP CONSTRAINT [FK_SessionGroupe_Groupe];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_SpecialiteAnimateur_Specialite]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[SpecialiteAnimateur] DROP CONSTRAINT [FK_SpecialiteAnimateur_Specialite];
GO
IF OBJECT_ID(N'[dbo].[FK_SpecialiteAnimateur_Animateur]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[SpecialiteAnimateur] DROP CONSTRAINT [FK_SpecialiteAnimateur_Animateur];
GO
...
CREATE TABLE [dbo].[SessionGroupe] (
    [Session_idSession] smallint  NOT NULL,
    [Groupe_idGroupe] smallint  NOT NULL
);
GO
...
CREATE TABLE [dbo].[SpecialiteAnimateur] (
    [Specialite_idSpacialite] smallint  NOT NULL,
    [Animateur_idMembre] smallint  NOT NULL
);
GO
...
-- Creating primary key on [Session_idSession], [Groupe_idGroupe] in table 'SessionGroupe'
ALTER TABLE [dbo].[SessionGroupe]
ADD CONSTRAINT [PK_SessionGroupe]
    PRIMARY KEY NONCLUSTERED ([Session_idSession], [Groupe_idGroupe] ASC);
GO

-- Creating primary key on [Specialite_idSpacialite], [Animateur_idMembre] in table 'SpecialiteAnimateur'
ALTER TABLE [dbo].[SpecialiteAnimateur]
ADD CONSTRAINT [PK_SpecialiteAnimateur]
    PRIMARY KEY NONCLUSTERED ([Specialite_idSpacialite], [Animateur_idMembre] ASC);
GO
...
-- Creating foreign key on [Session_idSession] in table 'SessionGroupe'
ALTER TABLE [dbo].[SessionGroupe]
ADD CONSTRAINT [FK_SessionGroupe_Session]
...
-- Creating foreign key on [Groupe_idGroupe] in table 'SessionGroupe'
ALTER TABLE [dbo].[SessionGroupe]
ADD CONSTRAINT [FK_SessionGroupe_Groupe]
    FOREIGN KEY ([Groupe_idGroupe])
    REFERENCES [dbo].[GroupeJeu]
        ([idGroupe])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_SessionGroupe_Groupe'
CREATE INDEX [IX_FK_SessionGroupe_Groupe]
...
-- Creating foreign key on [Specialite_idSpacialite] in table 'SpecialiteAnimateur'
ALTER TABLE [dbo].[SpecialiteAnimateur]
ADD CONSTRAINT [FK_SpecialiteAnimateur_Specialite]
    FOREIGN KEY ([Specialite_idSpacialite])
    REFERENCES [dbo].[SpecialiteJeu]
        ([idSpacialite])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating foreign key on [Animateur_idMembre] in table 'SpecialiteAnimateur'
ALTER TABLE [dbo].[SpecialiteAnimateur]
ADD CONSTRAINT [FK_SpecialiteAnimateur_Animateur]
    FOREIGN KEY ([Animateur_idMembre])
    REFERENCES [dbo].[MembresJeu_Animateur]
        ([idMembre])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_SpecialiteAnimateur_Animateur'
CREATE INDEX [IX_FK_SpecialiteAnimateur_Animateur]
