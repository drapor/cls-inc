<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="paiment_failure.aspx.vb"
        ...
        <div class="titlePanier" style="text-align:center;">
            <h3>
                <asp:Image ID="succesImage" runat="server" ToolTip="Échec" Width="75px" height="75px" ImageUrl="~/App_Themes/Original/img/failure.png" />Désolé <asp:Label
                    ...
                    <br />
                <asp:Button ID="btnLogin" runat="server" Text="Retour au paiment" CssClass="btn btn-primary btn-large btn" PostBackUrl="~/Page/Autre/inscription_paiement.aspx"  />
        </div>
    </div>
</asp:Content>
