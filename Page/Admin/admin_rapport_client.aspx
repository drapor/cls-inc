<%@ Page Title="" Language="VB" MasterPageFile="~/Page/Admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="admin_rapport_client.aspx.vb" Inherits="Page_Admin_admin_rapport_client" Theme="Original"%>
                ...
                <asp:ListView ID="lvEmployeNom" runat="server" DataSourceID="dsMembre" DataKeyNames="idMembre">
                    ...
                    <ItemTemplate>
                        <tr align="center" class="<%# GetCssName(Container) %>" style="font-size: 10px;">
                            ...
                            <th style="border: 1px solid #000000; width: 10%;">
                                <asp:Label ID="txtRole" runat="server" Text='<%# eval("RoleJeu.nomRole") %>'></asp:Label>
                            </th>
                            <th style="border: 1px solid #000000; width: 20%;">
