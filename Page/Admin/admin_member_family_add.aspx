<%@ Page Title="" Language="VB" MasterPageFile="~/Page/Admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="admin_member_family_add.aspx.vb" Inherits="Page_Admin_admin_member_family_add" Theme="Original"%>
...
<asp:ListView ID="lvMembreFamille" runat="server" DataSourceID="dsMembreFamille" DataKeyNames="idMembre" InsertItemPosition="LastItem" ItemPlaceholderID="itemPlaceHolder">
    ...
    <div class="containerFormulaire">
        ...
        <div class="validationListe">
                ...
                <div class="bouton" style="margin-left:290px;">
                    ...
                    <asp:Button ID="btnCancel" runat="server" Text="Annuler" CssClass="btn btn-primary btn-large btn" CausesValidation="false" PostBackUrl="~/Page/Admin/admin_home_member.aspx"/>
                </div>
    </div>
    </InsertItemTemplate>
</asp:ListView>
