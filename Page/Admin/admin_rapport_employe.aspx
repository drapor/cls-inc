<%@ Page Title="" Language="VB" MasterPageFile="~/Page/Admin/MasterPageAdmin.master"
    AutoEventWireup="false" CodeFile="admin_rapport_employe.aspx.vb" Inherits="Page_Admin_admin_rapport_employe"
    Theme="Original" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="menu" runat="Server">
    ...
    <div id="contentStart">
        <asp:MultiView ID="MVPrincipal" runat="server" ActiveViewIndex="0">
            <asp:View ID="viewNom" runat="server">
                <asp:Label ID="lblEmployeNom" runat="server" Text="Liste des Employés triés par nom de famille"
                    Font-Size="20px" Font-Bold="true" />
                <br />
                <br />
                <asp:ListView ID="lvEmployeNom" runat="server" DataSourceID="dsEmploye" DataKeyNames="idMembre">
                    <LayoutTemplate>
            ...
            <asp:View ID="viewCourriel" runat="server">
                <asp:Label ID="lblEmployeCourriel" runat="server" Text="Liste des Employés triés par courriel"
                    Font-Size="20px" Font-Bold="true" />
                <br />
                <br />
                <asp:ListView ID="lvEmployeCourriel" runat="server" DataSourceID="dsEmploye" DataKeyNames="idMembre">
                    <LayoutTemplate>
                        <table align="center" style="width: 100%; border: 1px solid #000000; font-weight: bolder;">
                            <tr style="background-color: #1800B8; color: White; font-size: 16px;">
                                <th style="border: 1px solid #000000; width: 25%;">
    ...
    <asp:EntityDataSource ID="dsEmploye" runat="server" ConnectionString="name=modelCLSContainer"
        ...
        EnableDelete="True" EnableInsert="True" EnableUpdate="True" Where="it.RoleJeu_idRole = 2">
