<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="admin_teacher_add.aspx.vb" Inherits="Page_Admin_admin_teacher_add" Theme="Original" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <div class="containerContenuAdmin">


<div class="titleAdminNormal">
    <asp:Label ID="lblAjouterAnimateur" runat="server" Text="Ajouter un animateur"></asp:Label>
</div>
