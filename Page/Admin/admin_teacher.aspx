<%@ Page Title="" Language="VB" MasterPageFile="~/Page/Admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="admin_teacher.aspx.vb" Inherits="Page_Admin_admin_teacher_add" Theme="Original" %>
<asp:Content ID="Content1" ContentPlaceHolderID="menu" Runat="Server">
    <div class="containerContenuAdmin">
        <div class="entetePage">
                <div class="menuPageGauche" style="margin-top:10px;">
                    <asp:Label ID="lblEntete" runat="server" text="Opérations Animateurs" Font-Size="32px" Font-Bold="true"/>
                </div>
            ...
            <asp:MultiView ID="MVPrincipal" runat="server" ActiveViewIndex="0">
                <asp:View ID="viewAjout" runat="server">
                    <div class="contenuStandard">
                        <asp:Label ID="lblTitreAjout" runat="server" text="Ajouter un Animateur" Font-Size="24px" Font-Bold="true"/>
                        <br />
                        <br />
                        <br />
                        ...
                        <div class="ligneFormulaire">
                             ...
                             <div class="elementFormulaire"><asp:TextBox ID="txtTelephone" runat="server" CssClass="search-query" SkinID="txtBoxBlue" Width="100px" MaxLength="13"></asp:TextBox>*</div>
                             <div class="elementFormulaireRequired">
                        ...
                        <div class="ligneFormulaire">
                             ...
                             <div class="elementFormulaire" style="margin-left:80px; margin-top:20px;">
                                 <asp:Button ID="btnAjouter" runat="server" Text="Ajouter un Animateur" CssClass="btn btn-primary btn-large btn" OnClick="ajouterEmployeClick"/>
                             </div>
                        </div>
                ...
                <asp:View ID="viewModifie" runat="server">
                    <div class="contenuStandard">
                        <asp:Label ID="lblTitreModifie" runat="server" text="Modifier un Animateur" Font-Size="24px" Font-Bold="true"/>
                        <br />
                        <br />
                        <br />
                        <div class="ligneFormulaire">
                        ...
                        <asp:ListView ID="lvInfoMembre" runat="server" DataSourceID="dsAnimateurModifie" DataKeyNames="idMembre">
                            <LayoutTemplate>
                            ...
                            <ItemTemplate>
                              ...
                              <div class="partiGaucheCourriel">
                                    ...
                                    <div class="boutonCourriel">
                                        ...
                                        <asp:Button ID="btnCancel" runat="server" CommandName="Cancel" Text="Annuler" CausesValidation="false" CssClass="btn btn-primary btn-small" PostBackUrl="~/Page/Admin/admin_teacher_modify.aspx"/>
                                    </div>
                              </EditItemTemplate>
                    </asp:ListView>
                ...
                <asp:View ID="viewSupprime" runat="server">
                    <div class="contenuStandard">
                        <asp:Label ID="lblTitreSupprime" runat="server" text="Supprimer un Animateur" Font-Size="24px" Font-Bold="true"/>
                        <br />
                        <br />
                        <br />
...
<asp:EntityDataSource ID="dsAnimateurModifie" runat="server" 
