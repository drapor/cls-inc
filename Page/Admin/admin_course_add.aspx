...
<div class="containerFormulaire">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtDateDebutInscription" runat="server" CssClass="datepicker search-query" SkinID="txtBoxBlue" MaxLength="10" ForeColor="Red" Width="80px" Text='<%#Bind("dateDebutInscription") %>'></asp:TextBox></div>
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtDateFinInscription" runat="server" CssClass="datepicker search-query" SkinID="txtBoxBlue" MaxLength="10" ForeColor="Red" Width="80px" Text='<%#Bind("dateFinInscription") %>'></asp:TextBox></div>
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtDateDebutCours" runat="server" CssClass="datepicker search-query" SkinID="txtBoxBlue" MaxLength="10" ForeColor="Red" Width="80px" Text='<%#Bind("dateDebutCours") %>'></asp:TextBox></div>
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtDateFinCours" runat="server" CssClass="datepicker search-query" SkinID="txtBoxBlue" MaxLength="10" ForeColor="Red" Width="80px" Text='<%#Bind("dateFinCours") %>'></asp:TextBox></div>
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire">
             <asp:Button ID="btnAjouter" runat="server" Text="Ajouter" CssClass="btn btn-primary btn-large btn" CommandName="Insert" />
