...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <div class="containerContenuAdmin">
        <div style="width: 940px; height: 35px; margin-bottom: 20px;">
            <div style="width: auto; height: 28px; float: left; margin-top: 5px; font-size: 28px;
                margin-left: 4px;">
                <asp:Label ID="lblOperation" runat="server" Text="Opération sur les cours" Font-Bold="true"></asp:Label>
            </div>
            <div style="width: auto; height: 28px; float: right; margin-right: 25px; margin-top: 5px;">
                <asp:Button ID="btnAjouter" runat="server" Text="Ajouter un cours" CssClass="btn btn-primary btn-medium btn" CausesValidation="false" OnClick="viewAjouter" />
                <asp:Button ID="btnModifier" runat="server" Text="Modifier un cours" CssClass="btn btn-primary btn-medium btn" CausesValidation="false" OnClick="viewModifier" />
                <asp:Button ID="btnSupprimer" runat="server" Text="Supprimer un cours" CssClass="btn btn-primary btn-medium btn" CausesValidation="false" OnClick="viewSupprimer" />
            </div>
        </div>
        <asp:MultiView ID="mvCours" runat="server" ActiveViewIndex="0">
            ...
            <asp:ListView ID="lvCours" runat="server" DataSourceID="dsCours" DataKeyNames="idCours">
                <LayoutTemplate>
                <div class="titleAdminNormal">
                            <asp:Label ID="lblSupprimerCours" runat="server" Text="Supprimer un cours"></asp:Label>
                        </div>
...
<LayoutTemplate>
   <asp:PlaceHolder runat="server" ID="itemPlaceHolder" />
    ...
    <div class="ligneFormulaire">
         <div class="elementFormulaireTexte"><asp:Label ID="lblTarif" runat="server" Text="Tarif"></asp:Label></div>
         <div class="elementFormulaire"><asp:TextBox ID="txtTarif" runat="server" CssClass="search-query" SkinID="txtBoxBlue" MaxLength="6" Width="50px" Text='<%#Bind("tarif") %>'></asp:TextBox></div>
         <div class="elementFormulaireRequired">
        <asp:RequiredFieldValidator ID="requiredTarif" runat="server" ErrorMessage="*Le tarif est obligatoire" ControlToValidate="txtTarif" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
        </div>
    </div> <%--Tarif Adulte--%>
            <div class="ligneFormulaire">
                <div class="elementFormulaireTexte">
