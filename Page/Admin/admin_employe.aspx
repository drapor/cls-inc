...
<div style="float: right; height: auto; width: auto;">
    ...
    <asp:MultiView ID="MVPrincipal" runat="server" ActiveViewIndex="0">
            ...
            <div class="ligneFormulaireAdmin">
                ...
                <div class="validation">
                    <asp:RequiredFieldValidator ID="requiredCourriel" runat="server" ErrorMessage="*L'adresse courriel est obligatoire"
                        ControlToValidate="txtCourriel" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
            ...
            <div class="ligneFormulaireAdmin">
                ...
                <div class="validation">
                    <asp:RequiredFieldValidator ID="requiredPrenom" runat="server" ErrorMessage="*Le prénom est obligatoire"
                        ControlToValidate="txtPrenom" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="validation">
                    <asp:RequiredFieldValidator ID="requiredNom" runat="server" ErrorMessage="*Le nom est obligatoire"
                        ControlToValidate="txtNom" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
            ...
            <div class="ligneFormulaireAdmin">
                ...
                <div class="validation">
                    <asp:RequiredFieldValidator ID="requiredAdresse" runat="server" ErrorMessage="*L'adresse est obligatoire"
                        ControlToValidate="txtAdresse" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="validation">
                    <asp:RequiredFieldValidator ID="requiredVille" runat="server" ErrorMessage="*La ville est obligatoire"
                        ControlToValidate="txtVille" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="elementFormulaireAdmin">
                    <asp:TextBox ID="txtDate" runat="server" CssClass="datepicker search-query" SkinID="txtBoxBlue"
                        MaxLength="10" ForeColor="Red" Width="72px" ValidationGroup="employe"></asp:TextBox>
                        </div>
                <div class="validation">
                <asp:RequiredFieldValidator ID="requiredDate" runat="server" ErrorMessage="*La date de naissance est obligatoire"
                    ControlToValidate="txtDate" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="regExDate" runat="server" ErrorMessage="*Votre date n'est pas dans le format aaaa/mm/jj"
                    ...
                    Display="Dynamic" ControlToValidate="txtDate" ForeColor="Red" ValidationGroup="employe">!</asp:RegularExpressionValidator>
                    </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="elementFormulaireAdmin">
                    <asp:TextBox ID="txtTelephone" runat="server" CssClass="search-query" SkinID="txtBoxBlue"
                        MaxLength="13" Width="100px"></asp:TextBox></div>
                <div class="validation">
                    <asp:RegularExpressionValidator ID="regExTelephone" runat="server" Display="Dynamic"
                        ...
                        ForeColor="Red" ControlToValidate="txtTelephone" ValidationExpression="^([\(]{1}[0-9]{3}[\)]{1}[0-9]{3}[\-]{1}[0-9]{4})$" ValidationGroup="employe">!</asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="requiredTelephone" runat="server" ErrorMessage="*Le téléphone est obligatoire"
                        ControlToValidate="txtTelephone" ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="validation">
                    <asp:RegularExpressionValidator ID="regExCodePostal" runat="server" ErrorMessage="*Veuillez entrer un code postal dans le format A1A 1A1"
                        ForeColor="Red" Display="Dynamic" ControlToValidate="txtCodePostal" ValidationExpression="[A-Z]\d[A-Z] \d[A-Z]\d" ValidationGroup="employe">!</asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="requiredCodePostal" runat="server" ErrorMessage="*Le code postal est obligatoire"
                        ControlToValidate="txtCodePostal" Display="Dynamic" ForeColor="Red" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="validation">
                    <asp:RegularExpressionValidator ID="regExMDP" runat="server" ErrorMessage="*Votre mot de passe doit contenir entre 8 et 20 caractère"
                        ControlToValidate="txtMDP" ForeColor="Red" Display="Dynamic" ValidationExpression="^[A-Za-z0-9]{8,}$" ValidationGroup="employe">!</asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="requiredMDP" Display="Dynamic" runat="server" ErrorMessage="*Le mot de passe est obligatoire"
                        ControlToValidate="txtMDP" ForeColor="Red" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                ...
                <div class="validation">
                    <asp:CompareValidator ID="compareMDPConfirm" runat="server" ErrorMessage="*Votre mot de passe ne correspond pas"
                        ForeColor="Red" ControlToCompare="txtMDP" ControlToValidate="txtMDPConfirm" Display="Dynamic" ValidationGroup="employe">!</asp:CompareValidator>
                    <asp:RequiredFieldValidator ID="requiredMDPConfirm" runat="server"
                        ErrorMessage="*Veuillez confirmez votre mot de passe" ControlToValidate="txtMDPConfirm"
                        ForeColor="Red" Display="Dynamic" ValidationGroup="employe">!</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                    <asp:Label ID="lblType" runat="server" Text="Type de compte"></asp:Label></div>
                <div class="elementFormulaireAdmin">
                    <asp:DropDownList ID="dropDownType" runat="server" SkinID="ddlBlue" AppendDataBoundItems="False"
        ...
        <asp:View ID="viewModifie" runat="server">
            ...
            <div class="ligneFormulaireAdmin">
                <div class="elementFormulaireTexte">
                    <asp:Label ID="lblChoisirEmploye" runat="server" Text="Choisissez l'employé"></asp:Label>
                </div>
                <div class="elementFormulaireAdmin">
    ...
    <asp:EntityDataSource ID="dsDropDownEmploye" runat="server" ConnectionString="name=modelCLSContainer"
        ...
        Where="(it.RoleJeu_idRole = 1 OR it.RoleJeu_idRole = 2)" Select="it.idMembre, it.RoleJeu_idRole,it.prenomMembre,(it.[prenomMembre]+' '+it.[nomMembre]) as FullName"
