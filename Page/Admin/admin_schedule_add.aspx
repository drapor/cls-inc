    ...
    <div class="contenuPage">
        <div class="entetePage">
            <div class="menuPageGauche" style="margin-top:10px;">
                <asp:Label ID="lblEntete" runat="server" text="Opérations horaires" Font-Size="32px" Font-Bold="true"/>
            </div>
                ...
                <div class="contenuStandard" style="width:860px;">
                    ...
                    <div class="ligneHoraire">
                        ...
                        <div class="interieurDroitHoraire">
                            ...
                            <br />
                            <div class="formatZone">
                                <asp:DropDownList ID="ddlNomGroupeAjout" SkinID="ddlBlue"  runat="server" CssClass="search-query" DataSourceID="dsGroupeAjout" DataTextField="NomGroupe" DataValueField="idGroupe" appendDataBoundItems="False"  MaxLength="16" Width="150px" AutoPostBack="True"></asp:DropDownList>
                            </div>
                            <br />
                        </div>
                    ...
                    <asp:ListView ID="lvAjout" runat="server" DataSourceID="dsHoraire" DataKeyNames="idHoraire" InsertItemPosition="LastItem">
                        <LayoutTemplate>
...
<%--            <asp:View ID="viewModifie" runat="server">
                <div class="contenuStandard" style="width:860px;">
                    ...
                    <div class="ligneHoraire">
                        ...
                        <div class="interieurDroit">
                            ...
                            <br />
                            <div class="formatZone">
                                <asp:DropDownList ID="ddlNomGroupeModifie" SkinID="ddlBlue"  runat="server" CssClass="search-query" DataSourceID="dsGroupeModifie" DataTextField="NomGroupe" DataValueField="idGroupe" appendDataBoundItems="False"  MaxLength="16" Width="150px" AutoPostBack="True"></asp:DropDownList>
                            </div>
                            <br />
                        </div>
                    </div> 
                ...
                <div class="contenuStandard">
                    <div class="ligneHoraire">
                        ...
                        <div class="interieurDroit">
                            ...
                            <br />
                            <div class="formatZone">
                                <asp:DropDownList ID="ddlNomGroupeSupprime" SkinID="ddlBlue"  runat="server" CssClass="search-query" DataSourceID="dsGroupeSupprime" DataTextField="NomGroupe" DataValueField="idGroupe" appendDataBoundItems="False"  MaxLength="16" Width="150px" AutoPostBack="True"></asp:DropDownList>
                            </div>
                            <br />
                        </div>
                    </div> 
    ...
    <WhereParameters>
        <asp:ControlParameter Name="coursID" ControlID="ddlNomCoursAjout" PropertyName="SelectedValue" Type="Int32" />
    </WhereParameters>
