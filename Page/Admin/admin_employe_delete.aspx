...
<div class="sectionTitre">
    ...
    <asp:ListView ID="lvEmploye" runat="server" DataSourceID="dsEmploye" DataKeyNames="idEmploye">
        <LayoutTemplate>
        ...
        <ItemTemplate>
            <div class="clientInfoGauche supprimerBoutonEmploye">
                ...
                <asp:Label ID="lblNomEmploye" runat="server" Text='<%# Eval("FullName") %>'></asp:Label>
                </div>
...
<%--    <asp:SqlDataSource ID="sqlDSemploye" runat="server"
    DeleteCommand="DELETE FROM MembresJeu_Employe WHERE idEmploye = @IDEmploye"
    SelectCommand="SELECT MembresJeu_Employe.idEmploye, MembresJeu_Employe.idMembresJeu"--%>
