...
<asp:Content ID="Content1" ContentPlaceHolderID="menu" runat="Server">
    ...
    <div style="float: right;">
        <asp:Label ID="lblListeAttente" runat="server" Text="" Visible="false" Font-Size="15px"
    ...
    <div style="width: 100%;">
        <asp:ListView ID="lvGroupe" runat="server" DataSourceID="dsGroupeAjout" DataKeyNames="idGroupe"
            ...
            <InsertItemTemplate>
                <tr align="center">
                    ...
                    <td style="border: 1px solid #000000; width: 40%;">
                        <asp:LinkButton ID="btnAjout" runat="server" Text="Ajouter un groupe" CommandName="Insert"
                            ValidationGroup="groupeAjout"></asp:LinkButton>
                    </td>
                    <td style="border: 1px solid #000000; width: 20%; padding-top: 10px;">
                        <asp:TextBox ID="txtNombreAjout" runat="server" Text='<%# Bind("nbMax") %>' Width="30px"
                ...
                <tr align="center" class="<%# GetCssName(Container) %>">
                    <td style="border: 1px solid #000000; width: 25%; height: 40px">
                        <asp:LinkButton ID="btnUpdate" runat="server" Text="Mise à jour" ForeColor="Black"
                            CommandName="Update" ValidationGroup="groupe"></asp:LinkButton>
                        /
                    ...
                    <td style="border: 1px solid #000000; width: 20%; padding-top: 10px;">
                        <asp:TextBox ID="txtNbMax" runat="server" Text='<%# Bind("nbMax") %>' Width="30px"
                            MaxLength="3"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="requiredNb" runat="server" ErrorMessage="*Nombres de membres"
