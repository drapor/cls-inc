<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ajouter_employe.aspx.vb" Inherits="Page_Admin_ajouter_employe" Theme="Original" %>
...
<div class="containerFormulaire">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtCourriel" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="50"></asp:TextBox></div>
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtPrenom" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="25"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtNom" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="25"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtAdresse" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="40"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtVille" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="25"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtDate" runat="server" CssClass="datepicker" SkinID="txtBoxBlue" MaxLength="10" ForeColor="Red"></asp:TextBox></div>
        <asp:RegularExpressionValidator ID="regExDate" runat="server" ErrorMessage="*Votre date n'est pas dans le format jj/mm/aaaa" ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$" Display="Dynamic" ControlToValidate="txtDate" ForeColor="Red"></asp:RegularExpressionValidator>
    </div>
    <div class="ligneFormulaire">
         <div class="elementFormulaireTexte"><asp:Label ID="lblTelephone" runat="server" Text="Téléphone"></asp:Label></div>
         <div class="elementFormulaire"><asp:TextBox ID="txtTelephone" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="13"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtCodePostal" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" Width="80px"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtMDP" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" MaxLength="20" TextMode="Password"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
             <asp:RegularExpressionValidator ID="regExMDP" runat="server" ErrorMessage="*Votre mot de passe doit contenir entre 8 et 20 caractère" ControlToValidate="txtMDP" ForeColor="Red" Display="Dynamic" ValidationExpression="^[A-Za-z]{8,}$"></asp:RegularExpressionValidator>
    ...
    <div class="ligneFormulaire">
         ...
         <div class="elementFormulaire"><asp:TextBox ID="txtMDPConfirm" runat="server" CssClass="textBoxRound" SkinID="txtBoxBlue" TextMode="Password"></asp:TextBox></div>
         <div class="elementFormulaireRequired">
        ...
        <asp:RequiredFieldValidator Display="Dynamic" ID="requiredMDPConfirm" runat="server" ErrorMessage="*Veuillez confirmez votre mot de passe" ControlToValidate="txtMDPConfirm" ForeColor="Red" ValidationGroup="{8,20}"></asp:RequiredFieldValidator>
        </div>
    </div>
    <div class="ligneFormulaire">
