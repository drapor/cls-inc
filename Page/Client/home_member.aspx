...
<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="home_member.aspx.vb" Inherits="Page_Client_home_member" Theme="Original" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <div class="contenuPage">
        ...
        <div class="contenuClient">
                ...
                <ItemTemplate>
                    ...
                    <div class="bouton">
                        <asp:Button ID="btnModifier" runat="server" CommandName="Edit" Text="Modifier les informations"
                            CssClass="btn btn-primary" OnClick="changeClient" />
                    </div>
                </ItemTemplate>
                <EditItemTemplate>
                        ...
                        <div class="clientValidation">
                            ...
                            <div class="formatZone">
                                <asp:RegularExpressionValidator ID="regExTelephone" runat="server" Display="Dynamic"
                                    ErrorMessage="*Entrer un numéro de téléphone de format (123)456-7890" ForeColor="Red"
                                    ControlToValidate="txtTelephoneClient" ValidationExpression="^([\(]{1}[0-9]{3}[\)]{1}[0-9]{3}[\-]{1}[0-9]{4})$"></asp:RegularExpressionValidator>
            ...
            <%--ListView informations personnelles--%>
            <div class="section" style="width: 900px;">
                <div class="sectionTitre" style="width: 880px;">
            ...
            <asp:ListView ID="lvCourriel" runat="server" DataSourceID="dsListView" DataKeyNames="idMembre">
                ...
                <ItemTemplate>
                    <div class="partiGauche" style="width: 120px; font-size: 16px; font-weight: bolder;
                        line-height: 25px;">
                        <asp:Label ID="lblCourriel" runat="server" Text="Votre courriel:" Font-Bold="True"></asp:Label>
                        </br>
                    </div>
                    <div class="partiDroite" style="font-size: 16px; font-weight: bolder; line-height: 25px;
                    ...
                    <div class="modifierBouton" style="margin-left: 20px;">
                        <asp:LinkButton ID="btnModifierCourriel" runat="server" Text="Modifier le courriel"
                            CommandName="Edit" OnClick="changeClient"></asp:LinkButton>
                        </br>
                    </div>
                </ItemTemplate>
                <EditItemTemplate>
                    ...
                    <div class="partiDroite" style="width: 230px;">
                        ...
                        <div class="formatZone">
                            <asp:TextBox ID="txtNouveauCourriel" runat="server" SkinID="txtBoxYellow" CssClass="search-query"
                                Text="" CausesValidation="false"></asp:TextBox>
                        </div>
                        </br>
                        <div class="formatZone">
                    ...
                    <div class="validationCourriel">
                        ...
                        <div class="formatZone">
                            <asp:RequiredFieldValidator ID="courrielRequis" runat="server" ErrorMessage="*Une addresse courriel est requise!"
                                ControlToValidate='txtNouveauCourriel' ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="regExCourriel" runat="server" ErrorMessage="*Veuillez entrer une adresse dans <br/> le format adresse@courriel.com!"
                        ...
                        <div class="formatZone">
                            <asp:RequiredFieldValidator ID="courrielRequisConfirme" runat="server" ErrorMessage="*Veuillez confirmer votre courriel!"
                                ControlToValidate='txtNouveauCourrielConfirme' ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:CompareValidator Display="Dynamic" ID="CompareCourriel" runat="server" ErrorMessage="*Votre courriel ne correspond pas!"
                                ForeColor="Red" ControlToCompare="txtNouveauCourriel" ControlToValidate="txtNouveauCourrielConfirme"></asp:CompareValidator>
                        </div>
                    </div>
                </EditItemTemplate>
            </asp:ListView>
            ...
            <asp:ListView ID="lvMotPasse" runat="server" DataSourceID="dsListView" DataKeyNames="idMembre">
                ...
                <ItemTemplate>
                    <div class="modifierBouton">
                        <asp:LinkButton ID="btnModifierMP" runat="server" CommandName="Edit" Text="Changer votre mot de passe"
                            OnClick="changeClient"></asp:LinkButton>
                    </div>
                </ItemTemplate>
                <EditItemTemplate>
                    ...
                    <div class="partiDroite" style="width: 250px; line-height: 25px;">
                        ...
                        <div class="formatZone">
                            <asp:TextBox ID="txtNouveauMPConfirme" runat="server" SkinID="txtBoxYellow" CssClass="search-query"
                                Text="" TextMode="Password"></asp:TextBox>
                        </div>
                        <div class="boutonSelection">
                            <asp:Button ID="btnAccepter" runat="server" CommandName="Update" Text="Accepter"
                    ...
                    <div class="validationMotPasse">
                        <div class="formatZone">
                            <asp:RequiredFieldValidator ID="motPasseValideRequis" runat="server" ErrorMessage="*Veuillez entrer votre présent mot de passe!"
                                ControlToValidate='txtPresentMP' ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        ...
                        <div class="formatZone">
                            <asp:RegularExpressionValidator ID="regExMDP" runat="server" ErrorMessage="*Votre mot de passe doit contenir entre 8 et <br/> 20 caractère"
                                ControlToValidate="txtNouveauMP" ForeColor="Red" Display="Dynamic" ValidationExpression="^[A-Za-z0-9]{8,}$"></asp:RegularExpressionValidator>
                            <asp:RequiredFieldValidator ID="motPasseRequis" runat="server" ErrorMessage="*Un mot de passe est requis!"
                                ControlToValidate='txtNouveauMP' ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        </br>
                        <div class="formatZone">
                            <asp:CompareValidator Display="Dynamic" ID="compareMP" runat="server" ErrorMessage="*Votre mot de passe ne correspond pas"
                                ForeColor="Red" ControlToCompare="txtNouveauMP" ControlToValidate="txtNouveauMPConfirme"></asp:CompareValidator>
                            <asp:RequiredFieldValidator Display="Dynamic" ID="requiredMDPConfirm" runat="server"
                                ErrorMessage="*Veuillez confirmez votre mot de passe" ControlToValidate="txtNouveauMPConfirme"
            ...
            <asp:ListView ID="lvFamille" runat="server" DataSourceID="dsFamille" DataKeyNames="idMembre">
                ...
                <ItemTemplate>
                    ...
                    <div class="supprimerFamille">
                        <asp:LinkButton ID="btnSupprimerFamille" runat="server" Text="Supprimer" CommandName="delete"
                            OnClientClick="return confirm('Veuillez confirmer la suppression');"></asp:LinkButton>
                    </div>
                </ItemTemplate>
            </asp:ListView>
            <div class="section" style="width: 900px;">
    ...
    <asp:EntityDataSource ID="dsFamille" runat="server" ConnectionString="name=modelCLSContainer"
        ...
        OrderBy="it.RoleJeu_idRole" Where="(@idFamille = it.familleID and (it.RoleJeu_idRole = 4 or it.RoleJeu_idRole = 5))">
        <WhereParameters>
