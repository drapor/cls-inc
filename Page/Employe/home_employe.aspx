...
<%@ Page Language="VB" MasterPageFile="~/Page/Employe/MasterPageEmploye.master" AutoEventWireup="false"
    CodeFile="home_employe.aspx.vb" Inherits="Page_Employe_home_employe" Theme="Original" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="menu" runat="Server">
    <asp:MultiView ID="MVEmploye" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="ViewAccueil" runat="server">
                    ...
                    <div>
                        ...
                        <div class="validation">
                            <div class="formatZone">
                                <asp:RequiredFieldValidator ID="requiredPrenom" runat="server" ErrorMessage="*Le prénom est obligatoire"
                                    ControlToValidate="txtPrenomClient" ForeColor="Red" Display="Dynamic" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                            </div>
                            </br>
                            <div class="formatZone">
                                <asp:RequiredFieldValidator ID="requiredNom" runat="server" ErrorMessage="*Le nom est obligatoire"
                                    ControlToValidate="txtNomClient" ForeColor="Red" Display="Dynamic" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                            </div>
                            </br>
                            <div class="formatZone">
                                <asp:RequiredFieldValidator ID="requiredAdresse" runat="server" ErrorMessage="*L'adresse est obligatoire"
                                    ControlToValidate="txtAdresseClient" ForeColor="Red" Display="Dynamic" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                            </div>
                            </br>
                            <div class="formatZone">
                                <asp:RequiredFieldValidator ID="requiredVille" runat="server" ErrorMessage="*La ville est obligatoire"
                                    ControlToValidate="txtVilleClient" ForeColor="Red" Display="Dynamic" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                            </div>
                            </br>
                            <div class="formatZone">
                                <asp:RequiredFieldValidator ID="requiredDate" runat="server" ErrorMessage="*La date de naissance est obligatoire"
                                    ControlToValidate="txtDate" ForeColor="Red" Display="Dynamic" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="regExDate" runat="server" ErrorMessage="*Votre date n'est pas dans le format aaaa/mm/jj"
                                    ...
                                    Display="Dynamic" ControlToValidate="txtDate" ForeColor="Red" ValidationGroup="infoPerso">*</asp:RegularExpressionValidator>
                            </div>
                            </br>
                            <div class="formatZone">
                                ...
                                <asp:RequiredFieldValidator ID="requiredTelephone" runat="server" ErrorMessage="*Le téléphone est obligatoire"
                                    ControlToValidate="txtTelephoneClient" ForeColor="Red" Display="Dynamic" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                            </div>
                            </br>
                            <div class="formatZone">
                                <asp:RegularExpressionValidator ID="regExCodePostal" runat="server" ErrorMessage="*Veuillez entrer un code postal dans le format A1A 1A1"
                                    ForeColor="Red" Display="Dynamic" ControlToValidate="txtPostalClient" ValidationExpression="[A-Z]\d[A-Z] \d[A-Z]\d"
                                    ValidationGroup="infoPerso">*</asp:RegularExpressionValidator>
                                <asp:RequiredFieldValidator ID="requiredCodePostal" runat="server" ErrorMessage="*Le code postal est obligatoire"
                                    ControlToValidate="txtPostalClient" Display="Dynamic" ForeColor="Red" ValidationGroup="infoPerso">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="bouton">
                            <asp:Button ID="btnAccepter" runat="server" CommandName="Update" Text="Accepter"
                                CssClass="btn btn-primary btn-small" ValidationGroup="infoPerso" />
            ...
            <asp:ListView ID="lvCourriel" runat="server" DataSourceID="dsListView" DataKeyNames="idMembre">
                ...
                <ItemTemplate>
                    ...
                    <div class="partiDroite" style="width: 160px; font-size: 16px; font-weight: bolder;
                        line-height: 25px; font-family: Times New Roman;">
        ...
        <asp:View ID="viewAjout" runat="server">
            <div class="contenuStandard" style="width: 700px;">
        ...
        <asp:View ID="viewModifier" runat="server">
            ...
            <div id="contentStart">
                <asp:MultiView ID="MVPrincipal" runat="server" ActiveViewIndex="0">
                    <asp:View ID="viewNom" runat="server">
                        <asp:Label ID="lblMembreNom" runat="server" Text="Liste des Clients à modifier/supprimer"
                        ...
                        <asp:ListView ID="lvMembreNom" runat="server" DataSourceID="dsMembre" DataKeyNames="idMembre">
                            ...
                            <ItemTemplate>
                                <tr align="center" class="<%# GetCssName(Container) %>" style="font-size: 10px;">
                                    ...
                                    <th style="border: 1px solid #000000; width: 15%;">
                                        <asp:LinkButton ID="btnSupprimer" runat="server" CommandName="Delete" ForeColor="Red"
                    ...
                    <asp:View ID="viewCourriel" runat="server">
                        <asp:Label ID="lblMembreCourriel" runat="server" Text="Liste des Clients à modifier/supprimer"
                            Font-Size="20px" Font-Bold="true" />
                        <br />
                        <br />
