<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="employe_home_member.aspx.vb" Inherits="Page_Employe_employe_home_member" Theme="Original"%>
...
<div class="bouton">
    <asp:Button ID="btnRetour" runat="server"  Text="Retour" CssClass="btn btn-primary btn-small" PostBackUrl="~/Page/Employe/home_employe.aspx" />
</div>
<script>
    $(function () {
