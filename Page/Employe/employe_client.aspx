<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeFile="employe_client.aspx.vb" Inherits="Page_Employe_employe_client" Theme="Original"  %>
                        ...
                        <asp:ListView ID="lvNouveauMembre" runat="server" DataSourceID="dsMembreAjout" DataKeyNames="idMembre" InsertItemPosition="LastItem" ItemPlaceholderID="itemPlaceHolder">
                            ...
                            <InsertItemTemplate>
                                <div class="ligneFormulaire">
                                    ...
                                    <asp:Label ID="lblCourriel" runat="server" Text="E-mail(*)"></asp:Label>
                                    </div>
                                    <div class="elementFormulaire">
                                    <asp:TextBox ID="txtCourriel" runat="server" CssClass="search-query" SkinID="txtBoxBlue" MaxLength="50" Text='<%# Bind("courriel") %>'></asp:TextBox>
                                    </div>
